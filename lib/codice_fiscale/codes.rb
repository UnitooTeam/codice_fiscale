...
module CodiceFiscale
  module Codes
    ...
    ODD_CODES = {
      ...
      '9' => 21, 'A' => 1, 'B' => 0, 'C' => 5, 'D' => 7, 'E' => 9, 'F' => 13, 'G' => 15, 'H' => 17, 'I' => 19, 'J' => 21, 'K' => 2, 'L' => 4, 'M' => 18, 'N' => 20, 'O' => 11, 'P' => 3, 'Q' => 6, 'R' => 8, 'S' => 12, 'T' => 14, 'U' => 16, 'V' => 10, 'W' => 22, 'X' => 25, 'Y' => 24, 'Z' => 23
    }
    ...
    def city(city_name, province_code)
      ...
      CSV.foreach config.city_codes_csv_path do |row|
        return row[2].upcase if city_name.casecmp(row[0]).zero? && province_code.casecmp(row[1]).zero?
      end
      nil
    end
    ...
    def country(country_name)
      ...
      CSV.foreach config.country_codes_csv_path do |row|
        return row[2].upcase if country_name.casecmp(row[0]).zero? || country_name.casecmp(row[1]).zero?
      end
      nil
    end
