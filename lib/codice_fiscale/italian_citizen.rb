module CodiceFiscale
  class ItalianCitizen
    ...
    MANDATORY_ATTRIBUTES = %i[name surname birthdate gender]
    ...
    validates_inclusion_of :gender, in: %i[male female]
    validates_length_of :province_code, is: 2, allow_blank: true
    validates_presence_of :city_name, :province_code, if: ->(obj) { obj.born_in_italy? }
    validate do
